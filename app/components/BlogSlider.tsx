...
const BlogSlider = () => {
  return (
    <div className="grid grid-cols-12 grid-rows-1 gap-8 w-screen">
      <div className="xl:col-span-8 col-span-10 col-start-2  text-white xl:col-start-2 ">
        <div className="m-6">
      ...
      <div className=":hidden text-center font-fugaz text-xl pt-3 xl:col-span-3 xl:col-start-10  xl:text-white">
        Blog Listesi
      </div>
    </div>
  );
