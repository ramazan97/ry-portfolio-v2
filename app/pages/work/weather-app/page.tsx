...
const Weather = () => {
  ...
  return (
    <div style={{ overflowY: "scroll", height: "102vh" }} className=" w-full xl:pt-40 h-screen bg-gradient-to-r from-violet-500 to-fuchsia-500 bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center px-4 lg:px-0">
      {errorMsg && (
